...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function showTablerAlert(title, message) {
        let modalEl = document.getElementById('offlineAlertModal');
        if (!modalEl) {
            modalEl = document.createElement('div');
            modalEl.id = 'offlineAlertModal';
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center py-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon mb-2 text-danger icon-lg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" style="width: 4rem; height: 4rem; margin: 0 auto; display: block;"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 9v2m0 4v.01" /><path d="M5 19h14a2 2 0 0 0 1.84 -2.75l-7.1 -12.25a2 2 0 0 0 -3.5 0l-7.1 12.25a2 2 0 0 0 1.75 2.75" /></svg>
                            <h3 id="offlineAlertTitle">Alert</h3>
                            <div class="text-muted" id="offlineAlertMessage">Message</div>
                        </div>
        ...
        document.getElementById('offlineAlertTitle').innerText = title;
        document.getElementById('offlineAlertMessage').innerText = message;
    ...
    function preventSubmit(e) {
        e.preventDefault();
        showTablerAlert('Offline Action Restricted', 'You are currently offline. Form submissions and data entry must be performed while online.');
    }
